...
exports.run = async (client, message, args) => {
  ...
  if (!rol) {
    const embed = new Discord.MessageEmbed()
      .setDescription(` <a:minikyanl:763031635532316694> Silinecek Rütbenin Rolünü Etiketleyin.`)
      .setColor("BLUE")
  ...
  if (rol.id === veri) {
    const embed = new Discord.MessageEmbed()
      .setDescription(
        `<a:minikdoru:763031811906732112> Başarıyla Rütbeler Arasında**${
    ...
    const embed = new Discord.MessageEmbed()
      .setDescription(` <a:minikyanl:763031635532316694> Rütbeler Arasında Böyle Bir Rütbe Bulamadım.`)
      .setColor("BLUE")
      .setFooter(client.user.username, client.user.avatarURL);
    message.channel.send(embed);
    return;
