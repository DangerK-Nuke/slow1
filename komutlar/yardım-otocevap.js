...
.setColor('BLUE') 
.setAuthor(`Slowex | Oto Cevap Komutları`, client.user.avatarURL())
.setDescription(`<a:hyqued3:763032004584538152> Slowex Botumuzu Eklemek İçin \`${prefix}davet\` Yazabilirsiniz.`)
.addField(`__Oto Cevap Ekle__`,`<a:krmzbakm:763134536358953020> \`${prefix}otocevap-ekle\` Sunucunuza Özel Komut Eklemenize Yarar.`,true)
.addField(`__Oto Cevap Liste__`,`<a:krmzbakm:763134536358953020> \`${prefix}otocevap-liste\` Sunucunuzdaki Özel Komutların Listesini Gösterir.`,true)
.addField(`__Oto Cevap Sil__`,`<a:krmzbakm:763134536358953020> \`${prefix}otocevap-sil\` Sunucunuzdaki Özel Komutu Siler.`,true)
...
exports.config = {
name: "otocevap-menü",
  aliases: ["yardım-otocevap","otocevap-sistemi"]
}
